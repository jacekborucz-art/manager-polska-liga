  ...
  return (
    <div className="agent-offer-shell relative min-h-screen overflow-hidden bg-slate-950 px-4 py-5 text-slate-50 sm:px-7 lg:px-10">
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100vh-40px)] w-full max-w-[1460px] flex-col">
        ...
        <main className="grid flex-1 grid-cols-1 gap-4 lg:grid-cols-[minmax(430px,0.82fr)_minmax(580px,1fr)]">
                ...
                <div className="relative z-10 mt-3 grid grid-cols-5 gap-2.5">
                  {[1, 2, 3, 4, 5].map(yearOption => (
                    <button
                      ...
                      disabled={isEnded}
                      className={`${DISPLAY_FONT} h-10 rounded-[10px] border text-base transition ${
                        years === yearOption
...
const MoneyControl: React.FC<{
  ...
  return (
    <div className={`${CELL_GLASS} min-h-[112px] p-4`}>
      <div className="relative z-10 flex h-full flex-col justify-between gap-3">
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex h-9 w-[132px] shrink-0 items-center justify-end gap-1.5 rounded-[9px] border border-blue-300/22 bg-black/38 px-2.5 shadow-[inset_0_1px_0_rgba(147,197,253,0.10)]">
            <input
              type="number"
              value={value}
              min={0}
              ...
              className={`${DISPLAY_FONT} w-[82px] bg-transparent text-right text-[15px] leading-none outline-none ${toneClass}`}
            />
