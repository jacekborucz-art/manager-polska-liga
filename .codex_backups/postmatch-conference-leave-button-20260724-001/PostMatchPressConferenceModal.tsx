      ...
      <div className="w-full max-w-5xl overflow-hidden rounded-[34px] border border-white/10 bg-slate-950 shadow-[0_30px_100px_rgba(0,0,0,0.75)]">
        ...
        <section className="space-y-5 px-8 py-7">
          <div>
            ...
            <p className="mt-3 rounded-2xl border border-blue-400/20 bg-blue-500/10 px-5 py-4 text-xl font-black italic uppercase tracking-tighter text-blue-100 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]">
              {question.text}
            </p>
          </div>
