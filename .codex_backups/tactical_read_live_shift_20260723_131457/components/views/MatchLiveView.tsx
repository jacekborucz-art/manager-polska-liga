...
const getAiUserPatternBriefingEffect = (
  ...
  return {
    actionMod: clampNumber(strength * 0.032, 0, 0.024),
    goalMod: clampNumber(strength * 0.016, 0, 0.012),
    momentumBonus: Math.round(strength * 12),
        ...
        if (activeAiBriefing) {
          if (isAiAttacking) {
            ...
            if (isUserAttacking && activeAiBriefing.userActionSuppression) {
               ...
               */
              shotThreshold -= clampNumber(activeAiBriefing.userActionSuppression, 0, 0.024);
            }
