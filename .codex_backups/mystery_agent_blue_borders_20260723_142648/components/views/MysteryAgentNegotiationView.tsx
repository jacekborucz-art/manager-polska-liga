...
const PANEL_GLASS = 'relative overflow-hidden rounded-[20px] border border-white/12 bg-slate-950/54 shadow-[inset_0_1px_0_rgba(255,255,255,0.10),0_24px_80px_rgba(0,0,0,0.48)] backdrop-blur-2xl';
const CELL_GLASS = 'relative overflow-hidden rounded-[16px] border border-white/12 bg-slate-950/48 shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_14px_40px_rgba(0,0,0,0.28)]';
        ...
        <div className="relative z-10 flex min-h-[calc(100vh-48px)] items-center justify-center">
          <div className={`${PANEL_GLASS} w-full max-w-lg p-8 text-center`}>
            ...
            <button
              ...
              className={`${DISPLAY_FONT} relative z-10 mt-6 inline-flex h-12 items-center justify-center rounded-full border border-white/15 bg-white px-7 text-sm text-slate-950 shadow-[0_12px_30px_rgba(255,255,255,0.12)]`}
            >
              Wróć
            </button>
          </div>
  ...
  return (
    <div className="agent-offer-shell relative min-h-screen overflow-hidden bg-slate-950 px-4 py-5 text-slate-50 sm:px-7 lg:px-10">
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100vh-40px)] w-full max-w-[1500px] flex-col">
        <header className="mb-6 shrink-0 border-b border-white/10 pb-5">
          <div className="flex items-start justify-between gap-5">
            ...
            <button
              onClick={() => navigateTo(ViewState.DASHBOARD)}
              className={`${DISPLAY_FONT} group inline-flex h-12 shrink-0 items-center justify-center gap-2 rounded-full border border-white/16 bg-white/7 px-5 text-xs text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.12),0_16px_45px_rgba(0,0,0,0.30)] backdrop-blur-xl transition hover:border-blue-300/45 hover:bg-blue-400/12`}
            >
        ...
        <main className="grid flex-1 grid-cols-1 gap-5 lg:grid-cols-[minmax(430px,0.82fr)_minmax(580px,1fr)]">
          <section className={`${PANEL_GLASS} p-5 sm:p-6`}>
            ...
            <div className="relative z-10 flex h-full min-h-0 flex-col">
              ...
              <div className="mt-5 grid grid-cols-2 overflow-hidden rounded-[18px] border border-white/12 bg-slate-950/38">
            ...
            <div className="relative z-10 flex h-full min-h-0 flex-col gap-5">
                    ...
                    <button
                      ...
                      className={`${DISPLAY_FONT} h-12 rounded-[12px] border text-lg transition ${
                        years === yearOption
                          ...
                          : 'border-white/8 bg-white/6 text-slate-400 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] hover:border-blue-300/35 hover:bg-blue-400/10'
                      }`}
                    >
                      {yearOption}
                    </button>
              ...
              <div className="mt-auto grid grid-cols-1 gap-3 md:grid-cols-[minmax(0,1fr)_minmax(160px,0.48fr)]">
                ...
                <button
                  ...
                  className={`${DISPLAY_FONT} inline-flex h-16 items-center justify-center gap-2 rounded-[12px] border border-white/9 bg-slate-700/34 px-5 text-base text-blue-100 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] transition hover:bg-blue-500/20 disabled:text-slate-500 disabled:opacity-70`}
                >
...
const InfoBox: React.FC<{ icon: AgentIconName; label: string; value: string; accent?: boolean }> = ({ icon, label, value, accent }) => (
  <div className="relative min-w-0 border-white/10 p-4 odd:border-r [&:nth-child(-n+2)]:border-b">
      ...
      <div className="relative z-10 flex items-start gap-4">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex h-10 min-w-[160px] items-center justify-end gap-2 rounded-[10px] border border-white/10 bg-black/35 px-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)]">
              <input
                type="number"
                value={value}
                min={0}
