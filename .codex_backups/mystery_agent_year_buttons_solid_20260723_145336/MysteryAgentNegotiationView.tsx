      ...
      <div className="relative z-10 mx-auto flex w-full max-w-[1460px] flex-col">
        <header className="mb-5 shrink-0 border-b border-blue-200/15 pb-4">
          <div className="flex items-start justify-between gap-5">
            ...
            <button
              onClick={() => navigateTo(ViewState.DASHBOARD)}
              className={`${DISPLAY_FONT} group inline-flex h-11 shrink-0 items-center justify-center gap-2 rounded-full border border-emerald-200/45 bg-emerald-500/16 px-5 text-xs text-emerald-100 shadow-[inset_0_1px_0_rgba(167,243,208,0.22),0_16px_45px_rgba(16,185,129,0.16)] backdrop-blur-xl transition hover:border-emerald-200/70 hover:bg-emerald-500/24`}
            >
              <AgentIcon name="close" className="h-4 w-4 text-emerald-200 transition group-hover:text-emerald-100" />
              WYJŚCIE
            </button>
          </div>
        </header>
                  ...
                  {[1, 2, 3, 4, 5].map(yearOption => (
                    <button
                      ...
                      className={`${DISPLAY_FONT} h-9 rounded-[8px] border text-sm transition ${
                        years === yearOption
                          ? 'border-[rgba(96,165,250,0.92)] bg-gradient-to-b from-blue-500/80 via-blue-700/72 to-blue-950/82 text-white shadow-[inset_0_1px_0_rgba(191,219,254,0.45),0_8px_20px_rgba(37,99,235,0.28)]'
                          : 'border-[rgba(96,165,250,0.16)] bg-gradient-to-b from-slate-700/34 via-slate-900/58 to-slate-950/72 text-slate-400 shadow-[inset_0_1px_0_rgba(148,163,184,0.16),0_8px_18px_rgba(0,0,0,0.22)] hover:border-[rgba(96,165,250,0.36)] hover:from-blue-900/28 hover:via-slate-900/60 hover:to-slate-950/76'
                      }`}
                    >
                      {yearOption}
                    </button>
