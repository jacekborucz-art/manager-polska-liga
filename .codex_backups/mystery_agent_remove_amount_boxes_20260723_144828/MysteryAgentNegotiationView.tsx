                ...
                <div className="relative z-10 mt-3 grid grid-cols-5 gap-2.5">
                  {[1, 2, 3, 4, 5].map(yearOption => (
                    <button
                      ...
                      disabled={isEnded}
                      className={`${DISPLAY_FONT} h-9 rounded-[10px] border text-sm transition ${
                        years === yearOption
                          ? 'border-[rgba(147,197,253,0.88)] bg-gradient-to-b from-blue-500/72 to-blue-800/58 text-white shadow-[inset_0_1px_0_rgba(147,197,253,0.40),0_10px_24px_rgba(37,99,235,0.32)]'
                          : 'border-[rgba(96,165,250,0.42)] bg-blue-950/22 text-slate-400 shadow-[inset_0_1px_0_rgba(96,165,250,0.12)] hover:border-[rgba(147,197,253,0.60)] hover:bg-blue-500/12'
                      }`}
                    >
                      {yearOption}
                    </button>
    ...
    <div className={`${CELL_GLASS} min-h-[96px] p-3.5`}>
      <div className="relative z-10 flex h-full flex-col justify-between gap-2.5">
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex h-8 w-[128px] shrink-0 items-center justify-end gap-1.5 rounded-[9px] border border-[rgba(96,165,250,0.48)] bg-blue-950/20 px-2.5 shadow-[inset_0_1px_0_rgba(96,165,250,0.14)]">
            <input
              type="number"
              value={value}
              min={0}
              ...
              className={`${DISPLAY_FONT} w-[80px] bg-transparent text-right text-[14px] leading-none outline-none ${toneClass}`}
            />
