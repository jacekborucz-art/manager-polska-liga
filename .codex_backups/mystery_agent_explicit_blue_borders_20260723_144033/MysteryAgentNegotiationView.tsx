...
const PANEL_GLASS = 'relative overflow-hidden rounded-[20px] border border-blue-400/32 bg-slate-950/54 shadow-[inset_0_1px_0_rgba(96,165,250,0.20),0_0_0_1px_rgba(37,99,235,0.12),0_24px_80px_rgba(0,0,0,0.48)] backdrop-blur-2xl';
const CELL_GLASS = 'relative overflow-hidden rounded-[16px] border border-blue-400/34 bg-slate-950/48 shadow-[inset_0_1px_0_rgba(96,165,250,0.18),0_0_0_1px_rgba(59,130,246,0.12),0_14px_40px_rgba(0,0,0,0.28)]';
        ...
        <main className="grid grid-cols-1 items-start gap-4 lg:grid-cols-[minmax(430px,0.82fr)_minmax(580px,1fr)]">
          <section className={`${PANEL_GLASS} p-4 sm:p-5`}>
            ...
            <div className="relative z-10 flex flex-col">
              ...
              <div className="mt-4 grid grid-cols-2 overflow-hidden rounded-[18px] border border-blue-300/20 bg-slate-950/38 shadow-[inset_0_1px_0_rgba(147,197,253,0.10)]">
            ...
            <div className="relative z-10 flex flex-col gap-3">
                  ...
                  {[1, 2, 3, 4, 5].map(yearOption => (
                    <button
                      ...
                      className={`${DISPLAY_FONT} h-9 rounded-[10px] border text-sm transition ${
                        years === yearOption
                          ? 'border-blue-300/85 bg-gradient-to-b from-blue-500/72 to-blue-800/58 text-white shadow-[inset_0_1px_0_rgba(147,197,253,0.40),0_10px_24px_rgba(37,99,235,0.32)]'
                          : 'border-blue-400/40 bg-blue-950/22 text-slate-400 shadow-[inset_0_1px_0_rgba(96,165,250,0.12)] hover:border-blue-300/55 hover:bg-blue-500/12'
                      }`}
                    >
                      {yearOption}
                    </button>
              ...
              <div className="grid grid-cols-3 gap-2.5">
                ...
                <button
                  ...
                  className={`${DISPLAY_FONT} inline-flex h-11 min-w-0 items-center justify-center gap-2 rounded-[10px] border border-blue-300/18 bg-blue-950/30 px-3 text-[clamp(0.62rem,0.74vw,0.78rem)] leading-none text-blue-100 shadow-[inset_0_1px_0_rgba(147,197,253,0.10)] transition hover:border-blue-300/34 hover:bg-blue-500/20 disabled:text-slate-500 disabled:opacity-70`}
                >
...
const InfoBox: React.FC<{ icon: AgentIconName; label: string; value: string; accent?: boolean }> = ({ icon, label, value, accent }) => (
  <div className="relative min-w-0 border-blue-400/30 p-4 odd:border-r [&:nth-child(-n+2)]:border-b">
    ...
    <div className={`${CELL_GLASS} min-h-[96px] p-3.5`}>
      <div className="relative z-10 flex h-full flex-col justify-between gap-2.5">
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex h-8 w-[128px] shrink-0 items-center justify-end gap-1.5 rounded-[9px] border border-blue-400/42 bg-blue-950/20 px-2.5 shadow-[inset_0_1px_0_rgba(96,165,250,0.14)]">
            <input
              type="number"
              value={value}
              min={0}
