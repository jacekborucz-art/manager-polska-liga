...
export const CLUB_LOGOS: Record<string, string> = {
  ...
  PL_RAKOW_CZESTOCHOWA_II:           rakowCzestochowaLogo,
  ...
  PL_SLASK_WROCLAW_II:               slaskWroclawLogo,
  ...
  PL_WIDZEW_LODZ_II:                 widzewLodzLogo,
  PL_WIECZYSTA_KRAKOW:               wieczyskaKrakowLogo,
  PL_WIECZYSTA_KRAKOW_II:            wieczyskaKrakowLogo,
  PL_WISLA_KRAKOW:                   wislaKrakowLogo,
  PL_WISLA_KRAKOW_II:                wislaKrakowLogo,
  PL_WISLA_PLOCK:                    wislaPlockLogo,
  PL_WISLA_PLOCK_II:                 wislaPlockLogo,
  PL_ZABKOVIA_ZABKI:                 zabkoviaZabkiLogo,
  PL_ZAGLEBIE_LUBIN:                 zaglebieLubinLogo,
  PL_ZAGLEBIE_LUBIN_II:              zaglebieLubinLogo,
