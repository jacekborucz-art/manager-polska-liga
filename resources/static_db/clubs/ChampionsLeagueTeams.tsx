...
export const RAW_CHAMPIONS_LEAGUE_CLUBS = [
  ...
  { name: "Real Madryt", country: "ESP", tier: 1, colors: ['#FFFFFF','rgba(5, 40, 179, 0.96)','#767b80'], stadium: "Santiago Bernabéu", capacity: 81044, reputation: 20 },
  ...
  { name: "Slovan Bratysława", country: "SVK", tier: 3, colors: ['#5B2D8B','#FFFFFF','#5B2D8B'], stadium: "Tehelné pole", capacity: 22500, reputation: 10 },
  { name: "Ferencváros Budapeszt", country: "HUN", tier: 3, colors: ['#008000','#FFFFFF','#008000'], stadium: "Groupama Arena", capacity: 23700, reputation: 9 },
  { name: "Malmö FF", country: "SWE", tier: 3, colors: ['#5BA4E5','#FFFFFF','#5BA4E5'], stadium: "Eleda Stadion", capacity: 22500, reputation: 11 },
  ...
  { name: "KÍ Klaksvík", country: "FRO", tier: 4, colors: ['#003A8F','#FFFFFF','#003A8F'], stadium: "Við Djúpumýrar", capacity: 3000, reputation: 8 },
  ...
  { name: "Struga Trim-Lum", country: "MKD", tier: 4, colors: ['#1E90FF','#FFFFFF','#1E90FF'], stadium: "Gradska Plaža", capacity: 8000, reputation: 7 },
  ...
  { name: "Astana", country: "KAZ", tier: 3, colors: ['#00AEEF','#FFD200','#00AEEF'], stadium: "Astana Arena", capacity: 30000, reputation: 11 },
  ...
  { name: "Shamrock Rovers", country: "IRL", tier: 4, colors: ['#007A33','#FFFFFF','#007A33'], stadium: "Tallaght Stadium", capacity: 10000, reputation: 7 },
