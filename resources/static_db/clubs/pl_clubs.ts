...
export const RAW_PL_CLUBS: RawClubData[] = [
  ...
  { name: "Polonia Warszawa", tier: 2, colors: ['#000000', '#FFFFFF', '#ff0000d0'], stadium: "Stadion Im. Gen. Kazimierza Sosnowskiego", capacity: 7150, reputation: 8, logoFile: 'Polonia_warszawa.png' },
