...
{/* Logika spadku dla Tier 1 i Tier 2 (3 ostatnie miejsca) */}
                                            ...
                                            {/* Logika spadku dla Tier 3 (4 ostatnie miejsca) */}
                                            {selectedLeagueId === 'L_PL_3' && 
                                              index > 13 && 
                                              sortedClubs[13] &&
                                              (club.stats.points + (34 - club.stats.played) * 3) < sortedClubs[13].stats.points && (
                                              <div className="flex items-center gap-1.5 shrink-0">
                                                <span className="bg-red-600 text-white text-[7px] font-black px-1.5 py-0.5 rounded-sm uppercase tracking-tighter leading-none shadow-lg animate-pulse">SPADEK</span>
                                              </div>
                                            )}
