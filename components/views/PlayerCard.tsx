...
const COUNTRY_FLAG_CODES: Record<string, string> = {
  ...
  'Nowa Zelandia': 'NZ',
  Gibraltar: 'GI', 'Irlandia Północna': 'GB', 'San Marino': 'SM', 'Wyspy Owcze': 'FO',
  Benin: 'BJ', Botswana: 'BW', 'Burkina Faso': 'BF', Burundi: 'BI', Czad: 'TD',
  'Demokratyczna Republika Konga': 'CD', Dżibuti: 'DJ', Erytrea: 'ER', Eswatini: 'SZ', Etiopia: 'ET',
  Gabon: 'GA', Gambia: 'GM', Gwinea: 'GN', 'Gwinea Bissau': 'GW', 'Gwinea Równikowa': 'GQ',
  Kenia: 'KE', Komory: 'KM', Kongo: 'CG', Lesotho: 'LS', Liberia: 'LR',
  Libia: 'LY', Madagaskar: 'MG', Malawi: 'MW', Mali: 'ML', Mauretania: 'MR',
  Mauritius: 'MU', Mozambik: 'MZ', Namibia: 'NA', Niger: 'NE',
  'Republika Południowej Afryki': 'ZA', 'Republika Środkowoafrykańska': 'CF',
  Rwanda: 'RW', Seszele: 'SC', 'Sierra Leone': 'SL', Somalia: 'SO',
  Sudan: 'SD', 'Sudan Południowy': 'SS', 'Wyspy Świętego Tomasza i Książęca': 'ST',
  Tanzania: 'TZ', Togo: 'TG', Uganda: 'UG', 'Wybrzeże Kości Słoniowej': 'CI',
  ...
  Kirgistan: 'KG', Malediwy: 'MV', Mongolia: 'MN', Nepal: 'NP',
  Pakistan: 'PK', 'Sri Lanka': 'LK', Tadżykistan: 'TJ', Turkmenistan: 'TM', Uzbekistan: 'UZ',
  Brunei: 'BN', 'Chinese Taipei': 'TW', Guam: 'GU',
  Ekwador: 'EC', Boliwia: 'BO',
  Kostaryka: 'CR', Panama: 'PA', Honduras: 'HN', Salwador: 'SV', Gwatemala: 'GT',
  Nikaragua: 'NI', Belize: 'BZ', Jamajka: 'JM', 'Trynidad i Tobago': 'TT', Haiti: 'HT',
  'Curaçao': 'CW', Surinam: 'SR', Kuba: 'CU', 'Republika Dominikany': 'DO',
  'Antigua i Barbuda': 'AG', Aruba: 'AW', Bahamy: 'BS', Barbados: 'BB', Bermudy: 'BM',
  Dominika: 'DM', Grenada: 'GD', Kajmany: 'KY', Montserrat: 'MS',
  'Saint Kitts i Nevis': 'KN', 'Saint Lucia': 'LC', 'Saint Vincent i Grenadyny': 'VC',
  'Turks i Caicos': 'TC', Anguilla: 'AI', 'Brytyjskie Wyspy Dziewicze': 'VG',
  'Francuska Gujana': 'GF', Gujana: 'GY', Portoryko: 'PR',
  'Stany Zjednoczone Wyspy Dziewicze': 'VI', Bonaire: 'BQ', Gwadelupa: 'GP',
  Martynika: 'MQ', 'Saint-Martin': 'MF', 'Sint Maarten': 'SX',
  Fidżi: 'FJ', 'Wyspy Salomona': 'SB', 'Papua-Nowa Gwinea': 'PG',
