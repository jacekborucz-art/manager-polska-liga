...
const WCQ_GROUP_I_PLAYED: PlayedMatch[] = [
  { round: 1, dateLabel: '21 MAR', home: 'Izrael',   away: 'Estonia',  homeGoals: 2,  awayGoals: 1 },
  { round: 1, dateLabel: '21 MAR', home: 'Norwegia', away: 'Mołdawia', homeGoals: 11, awayGoals: 1 },
  { round: 2, dateLabel: '24 MAR', home: 'Norwegia', away: 'Izrael',   homeGoals: 5,  awayGoals: 0 },
  { round: 2, dateLabel: '24 MAR', home: 'Mołdawia', away: 'Estonia',  homeGoals: 2,  awayGoals: 3 },
  { round: 3, dateLabel: '7 CZE',  home: 'Estonia',  away: 'Włochy',   homeGoals: 1,  awayGoals: 3 },
  { round: 3, dateLabel: '7 CZE',  home: 'Izrael',   away: 'Mołdawia', homeGoals: 4,  awayGoals: 1 },
  { round: 4, dateLabel: '10 CZE', home: 'Estonia',  away: 'Norwegia', homeGoals: 0,  awayGoals: 1 },
  { round: 4, dateLabel: '10 CZE', home: 'Włochy',   away: 'Izrael',   homeGoals: 3,  awayGoals: 0 },
];
...
const WCQ_GROUP_I_SCHEDULE: ScheduledMatch[] = [
  ...
  { round: 5,  dateLabel: '4 WRZ',  home: 'Włochy',   away: 'Mołdawia' },
  { round: 6,  dateLabel: '7 WRZ',  home: 'Norwegia', away: 'Włochy'   },
  { round: 6,  dateLabel: '7 WRZ',  home: 'Estonia',  away: 'Mołdawia' },
  { round: 7,  dateLabel: '8 PAŹ',  home: 'Mołdawia', away: 'Norwegia' },
  ...
  { round: 9,  dateLabel: '14 LIS', home: 'Norwegia', away: 'Estonia'  },
  { round: 9,  dateLabel: '14 LIS', home: 'Izrael',   away: 'Włochy'   },
  { round: 10, dateLabel: '17 LIS', home: 'Izrael',   away: 'Norwegia' },
  { round: 10, dateLabel: '17 LIS', home: 'Mołdawia', away: 'Włochy'  },
];

const WCQ_GROUP_J_PLAYED: PlayedMatch[] = [
  { round: 1, dateLabel: '21 MAR', home: 'Macedonia Północna', away: 'Kazachstan',         homeGoals: 1, awayGoals: 1 },
  { round: 1, dateLabel: '21 MAR', home: 'Belgia',             away: 'Liechtenstein',      homeGoals: 7, awayGoals: 0 },
  { round: 2, dateLabel: '24 MAR', home: 'Belgia',             away: 'Macedonia Północna', homeGoals: 0, awayGoals: 0 },
  { round: 2, dateLabel: '24 MAR', home: 'Liechtenstein',      away: 'Kazachstan',         homeGoals: 0, awayGoals: 2 },
  { round: 3, dateLabel: '7 CZE',  home: 'Kazachstan',         away: 'Walia',              homeGoals: 0, awayGoals: 1 },
  { round: 3, dateLabel: '7 CZE',  home: 'Macedonia Północna', away: 'Liechtenstein',      homeGoals: 5, awayGoals: 0 },
  { round: 4, dateLabel: '10 CZE', home: 'Kazachstan',         away: 'Belgia',             homeGoals: 1, awayGoals: 1 },
  { round: 4, dateLabel: '10 CZE', home: 'Walia',              away: 'Macedonia Północna', homeGoals: 7, awayGoals: 1 },
];
...
const WCQ_GROUP_J_SCHEDULE: ScheduledMatch[] = [
  ...
  { round: 6,  dateLabel: '7 WRZ',  home: 'Belgia',             away: 'Walia'              },
  { round: 6,  dateLabel: '7 WRZ',  home: 'Kazachstan',         away: 'Liechtenstein'      },
  { round: 7,  dateLabel: '8 PAŹ',  home: 'Liechtenstein',      away: 'Belgia'             },
  { round: 7,  dateLabel: '8 PAŹ',  home: 'Walia',              away: 'Kazachstan'         },
  { round: 8,  dateLabel: '11 PAŹ', home: 'Walia',              away: 'Belgia'             },
  { round: 8,  dateLabel: '11 PAŹ', home: 'Liechtenstein',      away: 'Macedonia Północna' },
  { round: 9,  dateLabel: '14 LIS', home: 'Belgia',             away: 'Kazachstan'         },
  { round: 9,  dateLabel: '14 LIS', home: 'Macedonia Północna', away: 'Walia'              },
  { round: 10, dateLabel: '17 LIS', home: 'Macedonia Północna', away: 'Belgia'             },
  { round: 10, dateLabel: '17 LIS', home: 'Liechtenstein',      away: 'Walia'              },
];

const WCQ_GROUP_K_PLAYED: PlayedMatch[] = [
  { round: 1, dateLabel: '21 MAR', home: 'Serbia',  away: 'Łotwa',   homeGoals: 2, awayGoals: 1 },
  { round: 1, dateLabel: '21 MAR', home: 'Anglia',  away: 'Andora',  homeGoals: 2, awayGoals: 0 },
  { round: 2, dateLabel: '24 MAR', home: 'Anglia',  away: 'Serbia',  homeGoals: 2, awayGoals: 0 },
  { round: 2, dateLabel: '24 MAR', home: 'Andora',  away: 'Łotwa',   homeGoals: 0, awayGoals: 1 },
  { round: 3, dateLabel: '7 CZE',  home: 'Łotwa',   away: 'Albania', homeGoals: 1, awayGoals: 1 },
  { round: 3, dateLabel: '7 CZE',  home: 'Serbia',  away: 'Andora',  homeGoals: 3, awayGoals: 0 },
  { round: 4, dateLabel: '10 CZE', home: 'Łotwa',   away: 'Anglia',  homeGoals: 0, awayGoals: 5 },
  { round: 4, dateLabel: '10 CZE', home: 'Albania', away: 'Serbia',  homeGoals: 0, awayGoals: 0 },
];

const GROUP_K_TEAMS = ['Anglia', 'Albania', 'Serbia', 'Łotwa', 'Andora'];

const WCQ_GROUP_K_SCHEDULE: ScheduledMatch[] = [
  { round: 5,  dateLabel: '4 WRZ',  home: 'Łotwa',   away: 'Serbia'  },
  { round: 5,  dateLabel: '4 WRZ',  home: 'Albania', away: 'Andora'  },
  { round: 6,  dateLabel: '7 WRZ',  home: 'Anglia',  away: 'Albania' },
  { round: 6,  dateLabel: '7 WRZ',  home: 'Łotwa',   away: 'Andora'  },
  { round: 7,  dateLabel: '8 PAŹ',  home: 'Andora',  away: 'Anglia'  },
  { round: 7,  dateLabel: '8 PAŹ',  home: 'Albania', away: 'Łotwa'   },
  { round: 8,  dateLabel: '11 PAŹ', home: 'Albania', away: 'Anglia'  },
  { round: 8,  dateLabel: '11 PAŹ', home: 'Andora',  away: 'Serbia'  },
  { round: 9,  dateLabel: '14 LIS', home: 'Anglia',  away: 'Łotwa'   },
  { round: 9,  dateLabel: '14 LIS', home: 'Serbia',  away: 'Albania' },
  { round: 10, dateLabel: '17 LIS', home: 'Serbia',  away: 'Anglia'  },
  { round: 10, dateLabel: '17 LIS', home: 'Andora',  away: 'Albania' },
];

const WCQ_GROUP_L_PLAYED: PlayedMatch[] = [
  { round: 1, dateLabel: '21 MAR', home: 'Czarnogóra',  away: 'Wyspy Owcze', homeGoals: 1, awayGoals: 0 },
  { round: 1, dateLabel: '21 MAR', home: 'Chorwacja',   away: 'Gibraltar',   homeGoals: 3, awayGoals: 0 },
  { round: 2, dateLabel: '24 MAR', home: 'Chorwacja',   away: 'Czarnogóra',  homeGoals: 4, awayGoals: 0 },
  { round: 2, dateLabel: '24 MAR', home: 'Gibraltar',   away: 'Wyspy Owcze', homeGoals: 0, awayGoals: 1 },
  { round: 3, dateLabel: '7 CZE',  home: 'Wyspy Owcze', away: 'Czechy',      homeGoals: 2, awayGoals: 1 },
  { round: 3, dateLabel: '7 CZE',  home: 'Czarnogóra',  away: 'Gibraltar',   homeGoals: 3, awayGoals: 1 },
  { round: 4, dateLabel: '10 CZE', home: 'Wyspy Owcze', away: 'Chorwacja',   homeGoals: 0, awayGoals: 1 },
  { round: 4, dateLabel: '10 CZE', home: 'Czechy',      away: 'Czarnogóra',  homeGoals: 2, awayGoals: 0 },
];

const GROUP_L_TEAMS = ['Chorwacja', 'Czechy', 'Wyspy Owcze', 'Czarnogóra', 'Gibraltar'];

const WCQ_GROUP_L_SCHEDULE: ScheduledMatch[] = [
  { round: 5,  dateLabel: '4 WRZ',  home: 'Wyspy Owcze', away: 'Czarnogóra'  },
  { round: 5,  dateLabel: '4 WRZ',  home: 'Czechy',      away: 'Gibraltar'   },
  { round: 6,  dateLabel: '7 WRZ',  home: 'Chorwacja',   away: 'Czechy'      },
  { round: 6,  dateLabel: '7 WRZ',  home: 'Wyspy Owcze', away: 'Gibraltar'   },
  { round: 7,  dateLabel: '8 PAŹ',  home: 'Gibraltar',   away: 'Chorwacja'   },
  { round: 7,  dateLabel: '8 PAŹ',  home: 'Czechy',      away: 'Wyspy Owcze' },
  { round: 8,  dateLabel: '11 PAŹ', home: 'Czechy',      away: 'Chorwacja'   },
  { round: 8,  dateLabel: '11 PAŹ', home: 'Gibraltar',   away: 'Czarnogóra'  },
  { round: 9,  dateLabel: '14 LIS', home: 'Chorwacja',   away: 'Wyspy Owcze' },
  { round: 9,  dateLabel: '14 LIS', home: 'Czarnogóra',  away: 'Czechy'      },
  { round: 10, dateLabel: '17 LIS', home: 'Czarnogóra',  away: 'Chorwacja'   },
  { round: 10, dateLabel: '17 LIS', home: 'Gibraltar',   away: 'Czechy'      },
];
