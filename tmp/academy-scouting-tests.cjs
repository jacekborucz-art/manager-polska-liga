...
var TRAINING_FACILITY_UPGRADE_COST_RANGES = {
  1: [12e5, 22e5],
  2: [32e5, 54e5],
  3: [7e6, 12e6],
  4: [14e6, 24e6],
...
var TRAINING_FACILITY_CONSTRUCTION_DAYS = {
  1: [75, 105],
  2: [90, 135],
  3: [120, 180],
  4: [150, 225],
...
var getBoardValuationCost = (club, fromLevel, projectId) => {
...
var getProjectCostBasis = (club, project) => {
...
var getConstructionDays = (fromLevel, seed) => {
...
var getPhaseLabel = (phase) => {
  const labels = {
    ...
    QUALITY_INSPECTION: "Odbi\xF3r jako\u015Bciowy",
    COMPLETED: "Zako\u0144czone",
    REJECTED: "Odrzucone"
  };
  return labels[phase];
};
var advancePhase = (club, project, currentDate) => {
    ...
    case "BOARD_REVIEW": {
      ...
      if (!canFundPreparation || s1 > approvalChance) {
        const updatedProject2 = {
          ...
          log: [...project.log, {
            date: currentDate,
            message: canFundPreparation ? `Zarz\u0105d wykona\u0142 wycen\u0119 (${valuation.cost.toLocaleString("pl-PL")} PLN), ale odrzuci\u0142 wniosek o rozbudow\u0119 bazy treningowej.` : `Zarz\u0105d wykona\u0142 wycen\u0119 (${valuation.cost.toLocaleString("pl-PL")} PLN) i uzna\u0142, \u017Ce klub nie ma wymaganych wolnych \u015Brodk\xF3w (${valuation.minimumCashRequired.toLocaleString("pl-PL")} PLN).`,
            type: "WARNING"
          }]
        };
        return {
          updatedProject: updatedProject2,
          updatedClub: {
            ...club,
            trainingFacilityUpgradeProjects: (club.trainingFacilityUpgradeProjects ?? []).map((p) => p.id === project.id ? updatedProject2 : p)
          },
          event: {
            projectId: project.id,
            newPhase: "REJECTED",
            subject: `Wycena bazy treningowej odrzucona \u2014 ${levelLabel}`,
            body: canFundPreparation ? `Szanowny Panie Mened\u017Cerze,
...
Po analizie zarz\u0105d uzna\u0142, \u017Ce obecny moment finansowy lub sportowy nie uzasadnia tej inwestycji. Do tematu mo\u017Cna wr\xF3ci\u0107 po poprawie bud\u017Cetu albo wynik\xF3w zespo\u0142u.

Z powa\u017Caniem,
Zarz\u0105d Klubu` : `Szanowny Panie Mened\u017Cerze,
    ...
    case "TECHNICAL_AUDIT": {
      ...
      if (club.budget < auditCost) {
        const updatedProject2 = {
          ...
          log: [...project.log, { date: currentDate, message: "Audyt zosta\u0142 wstrzymany z powodu braku \u015Brodk\xF3w na koszty przygotowawcze.", type: "WARNING" }]
        };
        return {
          updatedProject: updatedProject2,
          updatedClub: {
          ...
          event: {
            projectId: project.id,
            newPhase: "REJECTED",
            subject: `Brak \u015Brodk\xF3w na audyt \u2014 ${levelLabel}`,
            body: `Szanowny Panie Mened\u017Cerze,

Rozbudowa bazy treningowej zosta\u0142a wstrzymana, poniewa\u017C klub nie ma \u015Brodk\xF3w na pokrycie kosztu audytu technicznego (${auditCost.toLocaleString("pl-PL")} PLN).
...
Zarz\u0105d Klubu`,
    ...
    case "PLANNING_PERMISSION": {
      const outcome = s1 < 0.76 ? "APPROVED" : s1 < 0.9 ? "CONDITIONAL" : "REJECTED";
      if (outcome === "REJECTED") {
        const updatedProject2 = {
          ...project,
          phase: "REJECTED",
...
Zarz\u0105d Klubu`,
      ...
      const updatedProject = {
        ...
        log: [...project.log, {
          date: currentDate,
          message: outcome === "CONDITIONAL" ? "Pozwolenia wydano warunkowo. Zakres prac zostaje utrzymany, ale rosn\u0105 koszty zabezpiecze\u0144 i organizacji placu budowy." : "Pozwolenia wydane. Rozpoczynamy przetarg i zam\xF3wienia wyposa\u017Cenia.",
          type: "SUCCESS"
        }]
      };
      return {
...
Przechodzimy do przetargu, wyboru wykonawc\xF3w oraz zam\xF3wienia wyposa\u017Cenia treningowego.
    ...
    case "PROCUREMENT": {
      ...
      if (club.budget < totalCost) {
        const updatedProject2 = {
          ...
          phaseEndDate: currentDate,
          totalCost,
          log: [...project.log, { date: currentDate, message: `Po przetargu koszt wyni\xF3s\u0142 ${totalCost.toLocaleString("pl-PL")} PLN. Klub nie ma \u015Brodk\xF3w na rozpocz\u0119cie prac.`, type: "WARNING" }]
        };
        return {
          updatedProject: updatedProject2,
          updatedClub: {
    ...
    case "CONSTRUCTION": {
      ...
      if (delaySeed < 0.1) {
        ...
        const updatedProject2 = {
          ...
          log: [...project.log, { date: currentDate, message: `Op\xF3\u017Anienie prac o ${delayDays} dni z powodu problem\xF3w z dostaw\u0105 wyposa\u017Cenia.`, type: "DELAY" }]
        };
        return {
          updatedProject: updatedProject2,
          updatedClub: {
          ...
          event: {
            projectId: project.id,
            newPhase: "CONSTRUCTION",
            subject: `Op\xF3\u017Anienie bazy treningowej \u2014 ${levelLabel}`,
            body: `Szanowny Panie Mened\u017Cerze,

Wykonawca zg\u0142osi\u0142 op\xF3\u017Anienie w rozbudowie bazy treningowej (${levelLabel}). Termin przesuwa si\u0119 o ${delayDays} dni.
...
Zarz\u0105d Klubu`,
      ...
      const updatedProject = {
        ...
        log: [...project.log, { date: currentDate, message: "Prace budowlane zako\u0144czone. Rozpoczyna si\u0119 odbi\xF3r jako\u015Bciowy i certyfikacja sprz\u0119tu.", type: "SUCCESS" }]
      };
      return {
        updatedProject,
        updatedClub: {
        ...
        event: {
          ...
          subject: `Odbi\xF3r bazy treningowej \u2014 ${levelLabel}`,
          body: `Szanowny Panie Mened\u017Cerze,

Prace przy bazie treningowej zosta\u0142y zako\u0144czone. Trwa odbi\xF3r jako\u015Bciowy boisk, si\u0142owni, stref regeneracji oraz narz\u0119dzi analitycznych.
...
Zarz\u0105d Klubu`,
    ...
    case "QUALITY_INSPECTION": {
      const updatedProject = {
        ...
        phase: "COMPLETED",
        phaseEndDate: currentDate,
        log: [...project.log, { date: currentDate, message: `Odbi\xF3r jako\u015Bciowy pozytywny. Baza treningowa osi\u0105gn\u0119\u0142a Poziom ${project.targetLevel}.`, type: "SUCCESS" }]
      };
      return {
        updatedProject,
        updatedClub: {
...
Lepsze boiska, zaplecze motoryczne, regeneracja i analiza treningu od nast\u0119pnego tygodnia b\u0119d\u0105 wspiera\u0107 rozw\xF3j zawodnik\xF3w.
...
var TrainingFacilityService = class _TrainingFacilityService {
  static getEffectiveLevel(club) {
  ...
  static getDevelopmentProfile(level, staffQuality) {
  ...
  static getAcademyDevelopmentMultiplier(level) {
    const facilityIndex = (clampLevel(level) - 1) / 9;
    return 1 + Math.pow(facilityIndex, 0.9) * 0.08;
  }
  static checkEligibility(club) {
    const currentLevel = _TrainingFacilityService.getEffectiveLevel(club);
    if (currentLevel >= 10) {
      return { eligible: false, reasons: ["Baza treningowa ma ju\u017C maksymalny poziom."] };
    }
    const active = (club.trainingFacilityUpgradeProjects ?? []).some((project) => project.phase !== "COMPLETED" && project.phase !== "REJECTED");
    if (active) {
      return { eligible: false, reasons: ["Rozbudowa bazy treningowej ju\u017C jest w toku."] };
    }
    const estimatedCostRange = _TrainingFacilityService.getUpgradeCostRange(club, currentLevel) ?? void 0;
    const reasons = [];
    return {
  ...
  static createRequest(clubId, club, currentDate) {
    const fromLevel = _TrainingFacilityService.getEffectiveLevel(club);
    const targetLevel = clampLevel(fromLevel + 1);
    const estimatedCostRange = _TrainingFacilityService.getUpgradeCostRange(club, fromLevel) ?? { min: 0, max: 0 };
  ...
  static advanceDay(club, currentDate) {
...
var ACADEMY_UPGRADE_COSTS = {
  1: 25e5,
  2: 25e6,
  3: 4e7,
  4: 8e7
};
var ACADEMY_UPGRADE_DAYS = {
  1: 90,
  2: 120,
  3: 240,
  4: 365
};
var REPUTATION_COST_MULTIPLIERS = [
  { minRep: 1, maxRep: 2, multiplier: 0.4 },
  { minRep: 3, maxRep: 4, multiplier: 0.6 },
  { minRep: 5, maxRep: 6, multiplier: 1 },
  { minRep: 7, maxRep: 8, multiplier: 1.5 },
  { minRep: 9, maxRep: 10, multiplier: 2.5 }
];
var MIN_UPGRADE_COST = 1e6;
var ACADEMY_MAX_SLOTS = {
  1: 4,
  2: 6,
  3: 8,
  4: 10,
...
var READINESS_THRESHOLD = 70;
var BASE_WEEKLY_READINESS_GAIN = 1.4;
var BUDGET_MULTIPLIERS = [
  { min: 0, max: 3e4, multiplier: 0.5 },
  { min: 3e4, max: 7e4, multiplier: 0.8 },
  { min: 7e4, max: 15e4, multiplier: 1 },
  { min: 15e4, max: 3e5, multiplier: 1.2 },
  { min: 3e5, max: Infinity, multiplier: 1.4 }
];
var YOUTH_ATTR_KEYS = [
  "strength",
  "stamina",
...
var PROMOTION_CORE_KEYS = {
  ["GK" /* GK */]: ["goalkeeping", "positioning", "mentality", "strength", "defending", "workRate"],
  ["DEF" /* DEF */]: ["defending", "positioning", "strength", "heading", "stamina", "workRate", "mentality", "aggression", "pace"],
  ["MID" /* MID */]: ["passing", "technique", "dribbling", "pace", "vision", "attacking", "crossing", "freeKicks", "corners", "stamina"],
  ["FWD" /* FWD */]: ["finishing", "attacking", "pace", "dribbling", "positioning", "heading", "technique", "mentality"]
};
var ACADEMY_DEVELOPMENT_ATTR_KEYS = [
  "strength",
  "stamina",
  "pace",
  "defending",
...
function getPromotionOverallTarget(currentOverall, hiddenTalent, level, clubReputation) {
...
function applyYouthRegressionPressure(youth2, attributes, risk) {
  ...
  const currentOverall = PlayerAttributesGenerator.calculateOverall(updated, youth2.position);
  const protectedFloor = Math.max(42, Math.min(currentOverall - 2, youth2.hiddenTalent - 18));
  const eligibleKeys = ACADEMY_DEVELOPMENT_ATTR_KEYS.filter((key2) => updated[key2] > protectedFloor);
...
function generateYouthAttributes(position, hiddenTalent, rng, targetOverall) {
  ...
  YOUTH_ATTR_KEYS.forEach((key) => {
    ...
    if (weight >= 0.7) value += 3;
    if (weight <= 0.2) value -= 8;
...
var REGION_WEIGHTS = [
  { region: "POLAND" /* POLAND */, weight: 55 },
  { region: "BALKANS" /* BALKANS */, weight: 5 },
  { region: "CZ_SK" /* CZ_SK */, weight: 4 },
  { region: "SSA" /* SSA */, weight: 6 },
  { region: "IBERIA" /* IBERIA */, weight: 3 },
  { region: "GERMANY" /* GERMANY */, weight: 4 },
  { region: "BRAZIL" /* BRAZIL */, weight: 5 },
  { region: "ARGENTINA" /* ARGENTINA */, weight: 4 },
  { region: "FRANCE" /* FRANCE */, weight: 4 },
  { region: "HUNGARIAN" /* HUNGARIAN */, weight: 3 },
  { region: "EX_USSR" /* EX_USSR */, weight: 3 },
  { region: "ROMANIA" /* ROMANIA */, weight: 4 }
];
function pickRegion(regionFocus, rng) {
  if (regionFocus && rng() < 0.4) return regionFocus;
  const total = REGION_WEIGHTS.reduce((s, r2) => s + r2.weight, 0);
  let r = rng() * total;
...
var SCOUT_REGION_BASE_COST = {
  ["POLAND" /* POLAND */]: 5e3,
  ["CZ_SK" /* CZ_SK */]: 8e3,
  ["HUNGARIAN" /* HUNGARIAN */]: 8e3,
  ["BALKANS" /* BALKANS */]: 12e3,
  ["GERMANY" /* GERMANY */]: 15e3,
  ["ROMANIA" /* ROMANIA */]: 12e3,
  ["EX_USSR" /* EX_USSR */]: 18e3,
  ["IBERIA" /* IBERIA */]: 25e3,
  ["FRANCE" /* FRANCE */]: 25e3,
  ["SSA" /* SSA */]: 35e3,
  ["BRAZIL" /* BRAZIL */]: 5e4,
  ["ARGENTINA" /* ARGENTINA */]: 5e4
};
var SCOUT_REGION_BASE_COST_GLOBAL = 3e4;
var SCOUT_REGION_BASE_DAYS = {
  ["POLAND" /* POLAND */]: 30,
  ["CZ_SK" /* CZ_SK */]: 35,
  ["HUNGARIAN" /* HUNGARIAN */]: 35,
  ["BALKANS" /* BALKANS */]: 40,
  ["GERMANY" /* GERMANY */]: 42,
  ["ROMANIA" /* ROMANIA */]: 40,
  ["EX_USSR" /* EX_USSR */]: 45,
  ...
  ["SSA" /* SSA */]: 60,
  ["BRAZIL" /* BRAZIL */]: 65,
  ["ARGENTINA" /* ARGENTINA */]: 65
};
var SCOUT_REGION_BASE_DAYS_GLOBAL = 50;
var SCOUT_LEVEL_COST_MULT = { 1: 1, 2: 1, 3: 0.8, 4: 0.65, 5: 0.5 };
var SCOUT_LEVEL_DAYS_MULT = { 1: 1, 2: 1, 3: 0.85, 4: 0.7, 5: 0.55 };
function calcScoutCost(regionFocus, level) {
  const base = regionFocus ? SCOUT_REGION_BASE_COST[regionFocus] ?? SCOUT_REGION_BASE_COST_GLOBAL : SCOUT_REGION_BASE_COST_GLOBAL;
  return Math.round(base * (SCOUT_LEVEL_COST_MULT[level] ?? 1));
}
function calcScoutDays(regionFocus, level) {
  const base = regionFocus ? SCOUT_REGION_BASE_DAYS[regionFocus] ?? SCOUT_REGION_BASE_DAYS_GLOBAL : SCOUT_REGION_BASE_DAYS_GLOBAL;
  return Math.round(base * (SCOUT_LEVEL_DAYS_MULT[level] ?? 1));
}
var AcademyService = {
  // Generuje partię wychowanków (raz na rok – 1 Sierpnia)
  generateYouthIntake(level, regionFocus, season, existingCount, clubReputation = 5) {
    const seed = season * 7919 + level * 131 + Date.now() % 9999;
    const rng = seededRng2(seed);
    ...
    const result = [];
    const contractEnd = /* @__PURE__ */ new Date();
    ...
    for (let i = 0; i < count; i++) {
      ...
      result.push({
        ...
        attributes: attrs,
        hiddenTalent,
        revealedTalentRating: void 0,
        developmentFocus: void 0,
  ...
  processWeeklyDevelopment(youthPlayers, level, operationalBudgetWeekly, trainingFacilityLevel = 1, academyStaffQuality = 4) {
    ...
    const levelMult = 0.7 + (level - 1) * 0.15;
    ...
    return youthPlayers.map((youth2) => {
      if (youth2.contractSigned === false) return youth2;
      const talentMod = 0.6 + youth2.hiddenTalent / 100 * 0.8;
      const focusBonus = youth2.developmentFocus ? 0.5 : 0;
      const rawGain = BASE_WEEKLY_READINESS_GAIN * talentMod * budgetMult * levelMult * trainingFacilityYouthMult + focusBonus;
      let newReadiness = Math.min(100, youth2.readinessScore + rawGain);
      ...
      const regression = applyYouthRegressionPressure(youth2, updatedAttrs, regressionRisk);
      newReadiness = Math.max(0, newReadiness - regression.readinessPenalty);
      return {
        ...youth2,
        readinessScore: newReadiness,
        monthsInAcademy: youth2.monthsInAcademy + 0.25,
        attributes: regression.attributes
      };
    });
  },
  // Konwertuje YouthPlayer na pełnoprawnego Player (awans)
  promoteToPlayer(youth2, clubId, currentDate, clubReputation = 5, clubTier = 1, clubCountry, academyLevel = 1) {
    const contractEnd = new Date(currentDate);
    contractEnd.setFullYear(contractEnd.getFullYear() + 2);
    const currentOverall = PlayerAttributesGenerator.calculateOverall(youth2.attributes, youth2.position);
    const targetOverall = getPromotionOverallTarget(currentOverall, youth2.hiddenTalent, academyLevel, clubReputation);
    const promotionAttributes = targetOverall > currentOverall ? tuneAttributesTowardOverall(youth2.attributes, youth2.position, targetOverall, Math.min(88, Math.max(72, youth2.hiddenTalent + 8))) : { ...youth2.attributes };
    const overallRating = PlayerAttributesGenerator.calculateOverall(promotionAttributes, youth2.position);
    const promotedPlayer = {
      id: `PROMOTED_${youth2.id}`,
      firstName: youth2.firstName,
      lastName: youth2.lastName,
      age: youth2.age,
      clubId,
      nationality: youth2.nationality,
      nationalityCountry: youth2.nationalityCountry,
      position: youth2.position,
      overallRating,
      ...
      suspensionMatches: 0,
      contractEndDate: contractEnd.toISOString().split("T")[0],
      annualSalary: 3e4 + Math.round(youth2.hiddenTalent * 500),
      ...
      history: [
        {
          clubName: "Akademia",
          clubId: "ACADEMY",
          fromYear: currentDate.getFullYear() - Math.round(youth2.monthsInAcademy / 12),
  ...
  buildScoutMission(targetYouthPlayerId, regionFocus, level, currentDate, positionFilter, ageMin, ageMax, missionDays, missionCost, scoutId) {
    const daysNeeded = missionDays ?? (targetYouthPlayerId ? level <= 2 ? 14 : level <= 3 ? 10 : 7 : calcScoutDays(regionFocus, level));
  ...
  evaluateUpgradeProposal(academy, reputation) {
    const cost = ACADEMY_UPGRADE_COSTS[academy.level];
    const entry = REPUTATION_COST_MULTIPLIERS.find((r) => reputation >= r.minRep && reputation <= r.maxRep) ?? REPUTATION_COST_MULTIPLIERS[2];
    const realCost = Math.max(MIN_UPGRADE_COST, Math.round((cost ?? 0) * entry.multiplier));
    let chance;
    if (reputation >= 9) chance = 0.8;
    else if (reputation >= 7) chance = 0.65;
    else if (reputation >= 5) chance = 0.5;
  ...
  getProposalDecisionDate(currentLevel, fromDate) {
    const ranges = {
      1: [7, 14],
      2: [30, 60],
      3: [60, 90],
  ...
  getUpgradeCostForClub(currentLevel, reputation) {
  ...
  getDefaultOperationalBudget(level) {
    const base = { 1: 4e4, 2: 8e4, 3: 15e4, 4: 25e4, 5: 4e5 };
    return base[level];
  },
  // Czy przyszło dzisiaj zakończenie upgrade'u?
  checkUpgradeCompletion(academy, currentDate) {
  ...
  processCompletedMissions(academy, currentDate) {
    const dateStr = currentDate.toISOString().split("T")[0];
    const completedMissions = [];
    const updatedMissions = [];
    let updatedYouthPlayers = [...academy.youthPlayers];
    academy.activeMissions.forEach((mission2) => {
      if (mission2.completionDate <= dateStr) {
        completedMissions.push(mission2);
        if (mission2.targetYouthPlayerId) {
          updatedYouthPlayers = updatedYouthPlayers.map((yp) => {
            if (yp.id !== mission2.targetYouthPlayerId) return yp;
            return {
              ...yp,
  ...
  tryGenerateEvent(academy, currentDate, clubName) {
    ...
    const events = [
      () => {
        ...
        if (!star) return null;
        return `Tw\xF3j wychowanek ${star.firstName} ${star.lastName} ol\u015Bni\u0142 trener\xF3w na turnieju U-19. Jego pewno\u015B\u0107 siebie ro\u015Bnie!`;
      },
      () => {
      ...
      () => {
        return `Akademia ${clubName} zorganizowa\u0142a ob\xF3z sparingowy. Wychowankowie wr\xF3cili z nowym nastawieniem.`;
      },
      () => {
  ...
  resolveRegionalScoutingResult(mission2, academyLevel, slotsAvailable, networkDepth = 10, completionDate, clubReputation = 5, discoveryChance, extraCandidateChance = 0) {
    ...
    const result = [];
    for (let i = 0; i < count; i++) {
      const pos = mission2.positionFilter ?? pick(positionPool, rng);
      const region = mission2.regionFocus ?? pickRegion(void 0, rng);
      const name = NameGeneratorService.getRandomName(region);
      const ageMin = mission2.ageMin ?? 15;
...
var TOTAL_POOL_SIZE = 80;
var MARKET_SIZE = 12;
var MARKET_REFRESH_DAYS = 45;
var SALARY_PER_POINT = 850;
function speedMultiplier(reportSpeed) {
  return Math.max(0.7, Math.min(1.27, 1 - (reportSpeed - 10) / 10 * 0.3));
}
function costMultiplier(networkDepth) {
  return Math.max(0.8, Math.min(1.18, 1 - (networkDepth - 10) / 10 * 0.2));
}
function getPersonalityReportMultiplier(personality) {
  if (personality === "CONSERVATIVE") return 0.8;
  if (personality === "AMBITIOUS") return 0.9;
  if (personality === "RISK_TAKER") return 1.2;
  return 1;
}
function getReportConfidenceValue(scout, targetPosition) {
...
var PERSONALITIES2 = ["RISK_TAKER", "CONSERVATIVE", "VERSATILE", "AMBITIOUS"];
var SCOUT_REGIONS_OTHER = [
  "GERMANY" /* GERMANY */,
  "FRANCE" /* FRANCE */,
  "IBERIA" /* IBERIA */,
  "BALKANS" /* BALKANS */,
...
function pickNationality(rng) {
  return rng() < 0.75 ? "POLAND" /* POLAND */ : pick2(SCOUT_REGIONS_OTHER, rng);
}
function calcMinReputation(totalStats) {
...
var ScoutService = {
  ...
  generateScoutPool(seed) {
    ...
    for (let i = 0; i < TOTAL_POOL_SIZE; i++) {
      ...
      const personality = pick2(PERSONALITIES2, rng);
      ...
      if (personality === "RISK_TAKER") {
        networkBase = Math.min(20, networkBase + rngInt(rng, 2, 5));
        judgeBase = Math.max(1, judgeBase - rngInt(rng, 1, 3));
      }
      if (personality === "CONSERVATIVE") {
        judgeBase = Math.min(20, judgeBase + rngInt(rng, 2, 4));
        expBase = Math.min(20, expBase + rngInt(rng, 1, 3));
        networkBase = Math.max(1, networkBase - rngInt(rng, 1, 3));
      }
      if (personality === "AMBITIOUS") {
        judgeBase = Math.min(20, judgeBase + rngInt(rng, 1, 3));
        speedBase = Math.min(20, speedBase + rngInt(rng, 1, 2));
      }
      if (age >= 50) expBase = Math.min(20, expBase + rngInt(rng, 2, 5));
      if (age <= 35) expBase = Math.max(1, expBase - rngInt(rng, 1, 4));
      const regionalSpecialty = rng() < 0.6 ? nationality : rng() < 0.3 ? pick2(SCOUT_REGIONS_OTHER, rng) : void 0;
      const positions = ["GK" /* GK */, "DEF" /* DEF */, "MID" /* MID */, "FWD" /* FWD */];
      const positionSpecialty = rng() < 0.4 ? pick2(positions, rng) : void 0;
      const totalStats = judgeBase + networkBase + speedBase + expBase;
      const weeklySalary = Math.round(totalStats * SALARY_PER_POINT / 1e3) * 1e3;
      scouts.push({
  ...
  generateMarket(pool, clubReputation, boardKompetencja) {
    const KOMPETENCJA_SCOUT_OFFSET = {
      bardzo_wysoka: 3,
      wysoka: 1,
      przecietna: 0,
      niska: -1,
  ...
  getAnnualIntakeDays(scout, regionFocus) {
  ...
  getMissionCost(scout, regionFocus, academyLevel) {
    ...
    return Math.max(3e3, Math.round(cost / 500) * 500);
  },
  getDiscoveryChance(scout, regionFocus, academyLevel) {
    const baseChance = { 1: 0.45, 2: 0.52, 3: 0.6, 4: 0.68, 5: 0.75 };
    const networkBonus = (scout.networkDepth - 10) * 0.01;
    const regionalBonus = scout.regionalSpecialty === regionFocus ? 0.05 : 0;
    const personalityBonus = scout.personality === "RISK_TAKER" ? 0.03 : scout.personality === "CONSERVATIVE" ? -0.02 : scout.personality === "AMBITIOUS" ? 0.01 : 0;
    return Math.max(0.2, Math.min(0.9, (baseChance[academyLevel] ?? 0.5) + networkBonus + regionalBonus + personalityBonus));
  },
  getFollowUpCost(originalMissionCost) {
    return Math.max(3e3, Math.round(originalMissionCost * 0.25 / 500) * 500);
  },
  // Ocena talentu przez skauta (zamiast poziomu akademii)
  revealTalentWithScout(hiddenTalent, scout, targetPosition) {
  ...
  getReportConfidence(scout, targetPosition) {
  ...
  createCandidateReport(youth2, scout) {
    const score = getReportConfidenceValue(scout, youth2.position);
    let spread = Math.round(12 - score * 0.42);
    spread = Math.max(2, spread);
    if (scout.positionSpecialty === youth2.position) spread = Math.max(2, Math.round(spread * 0.7));
    spread = Math.max(2, Math.round(spread * getPersonalityReportMultiplier(scout.personality)));
    const attributeEstimates = {};
    Object.keys(youth2.attributes).forEach((key) => {
      const actual = youth2.attributes[key];
    ...
    const talentRating = ScoutService.revealTalentWithScout(youth2.hiddenTalent, scout, youth2.position);
    return {
      scoutName: `${scout.firstName} ${scout.lastName}`,
      confidence: ScoutService.getReportConfidence(scout, youth2.position),
      talentRating,
      attributeEstimates,
      recommendation: talentRating === "EXCEPTIONAL" || talentRating === "HIGH" ? "SIGN" : talentRating === "AVERAGE" ? "OBSERVE" : "REJECT"
    };
  },
  refineCandidateReport(candidate, scout) {
    const freshReport = ScoutService.createCandidateReport(candidate, scout);
    const attributeEstimates = {};
    Object.keys(candidate.scoutReport.attributeEstimates).forEach((key) => {
    ...
    const confidenceOrder = ["LOW", "MEDIUM", "HIGH", "VERY_HIGH"];
  ...
  getPersonalityLabel(personality) {
    switch (personality) {
      case "RISK_TAKER":
        return { label: "Ryzykant", color: "text-orange-400", description: "Szuka diament\xF3w \u2014 wysoka sie\u0107 kontakt\xF3w, ale mo\u017Ce przegapi\u0107 przeci\u0119tnych" };
      case "CONSERVATIVE":
        return { label: "Konserwatywny", color: "text-blue-400", description: "Niezawodny i dok\u0142adny, rzadko si\u0119 myli, ale nie odkryje geniusza" };
      case "VERSATILE":
        return { label: "Wszechstronny", color: "text-emerald-400", description: "Brak specjalizacji, ale dzia\u0142a skutecznie wsz\u0119dzie" };
      case "AMBITIOUS":
        return { label: "Ambitny", color: "text-violet-400", description: "Szybkie raporty i dobra ocena, wymaga lepszego klubu" };
    }
  },
...
// tests/AcademyScoutingTests.ts
function assert(condition, message) {
  if (!condition) throw new Error(message);
}
var createScout = (overrides = {}) => ({
  id: "SCOUT_TEST",
  firstName: "Jan",
  lastName: "Testowy",
  age: 42,
  ...
  reportSpeed: 16,
  experience: 16,
  regionalSpecialty: "POLAND" /* POLAND */,
...
var strongScout = createScout();
var weakScout = createScout({
  id: "SCOUT_WEAK",
  judgmentAccuracy: 4,
  networkDepth: 4,
  reportSpeed: 4,
  ...
  positionSpecialty: void 0
});
assert(
  ScoutService.getMissionCost(strongScout, "POLAND" /* POLAND */, 1) < ScoutService.getMissionCost(weakScout, "POLAND" /* POLAND */, 1),
  "Lepsza sie\u0107 kontakt\xF3w powinna obni\u017Ca\u0107 koszt misji."
);
assert(
  ScoutService.getMissionDays(strongScout, "POLAND" /* POLAND */, 1) < ScoutService.getMissionDays(weakScout, "POLAND" /* POLAND */, 1),
  "Wi\u0119ksza mobilno\u015B\u0107 powinna skraca\u0107 misj\u0119."
);
assert(
  ScoutService.getAnnualIntakeDays(strongScout, "POLAND" /* POLAND */) < ScoutService.getAnnualIntakeDays(weakScout, "POLAND" /* POLAND */),
  "Lepszy i wyspecjalizowany skaut powinien szybciej zako\u0144czy\u0107 coroczny nab\xF3r."
);
assert(
  ScoutService.getDiscoveryChance(strongScout, "POLAND" /* POLAND */, 1) > ScoutService.getDiscoveryChance(weakScout, "POLAND" /* POLAND */, 1),
...
var strongReport = ScoutService.createCandidateReport(youth, strongScout);
var weakReport = ScoutService.createCandidateReport(youth, weakScout);
var strongTechnique = strongReport.attributeEstimates.technique;
var weakTechnique = weakReport.attributeEstimates.technique;
assert(
  strongTechnique.max - strongTechnique.min < weakTechnique.max - weakTechnique.min,
  "Dok\u0142adniejszy skaut powinien prezentowa\u0107 w\u0119\u017Cszy zakres oceny atrybut\xF3w."
);
var startDate = /* @__PURE__ */ new Date("2026-08-09T12:00:00Z");
var mission = AcademyService.buildScoutMission(
  void 0,
  "POLAND" /* POLAND */,
  1,
  startDate,
...
assert(mission.cost === 4e3 && mission.scoutId === strongScout.id, "Misja powinna zapisa\u0107 koszt i przypisanego skauta.");
var annualIntake = AcademyService.generateYouthIntake(1, "POLAND" /* POLAND */, 2026, 0, 5);
assert(
  annualIntake.length >= 3 && annualIntake.length <= 4,
  "Coroczny nab\xF3r akademii poziomu 1 powinien przygotowa\u0107 3\u20134 kandydat\xF3w niezale\u017Cnie od zaj\u0119tych miejsc."
);
assert(
  annualIntake.every((candidate) => candidate.age >= 14 && candidate.age <= 17),
  "Coroczny nab\xF3r powinien wyszukiwa\u0107 kandydat\xF3w w wieku 14\u201317 lat."
);
