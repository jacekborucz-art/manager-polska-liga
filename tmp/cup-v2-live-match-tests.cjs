...
var CupShadowSimulationService = {
  ...
  tickLiveMatch: (handle2, targetSecond) => {
    const finished = CupMatchEngineV2.advanceLiveMatch(handle2.live, targetSecond);
    const result = finished ?? CupMatchEngineV2.snapshotLiveMatch(handle2.live);
    ...
    return {
      ...
      summary,
      initialLineup: {
        HOME: { startingXI: handle2.live.initialLineups.HOME, bench: handle2.live.initialBench.HOME },
        AWAY: { startingXI: handle2.live.initialLineups.AWAY, bench: handle2.live.initialBench.AWAY }
      },
