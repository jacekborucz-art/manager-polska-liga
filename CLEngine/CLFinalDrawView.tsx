...
export const CLFinalDrawView: React.FC = () => {
  ...
  const finalists = useMemo(() => CLDrawService.getSFWinners(fixtures), [fixtures]);
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <p className="text-slate-400 text-xs mt-1">
                Para finałowa wyłoniona · Mecz jednorazowy · 30 maja
              </p>
            </div>
          </div>
          <button
          ...
          <div className="relative z-10 w-full max-w-2xl flex flex-col gap-6">
            ...
            {userIsFinalist && (
              <div className="text-center">
                <span className="inline-block px-5 py-2 rounded-full bg-amber-400/10 border border-amber-400/30 text-amber-400 text-[10px] font-black uppercase tracking-[0.4em]">
