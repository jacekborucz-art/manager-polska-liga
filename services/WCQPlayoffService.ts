...
const PREGAME_BY_GROUP: Record<string, StaticMatch[]> = {
  ...
  L: [
    ...
    { home: 'Czarnogóra',  away: 'Wyspy Owcze', homeGoals: 2, awayGoals: 2 },
    { home: 'Gibraltar',   away: 'Czarnogóra',  homeGoals: 1, awayGoals: 2 },
    { home: 'Czechy',      away: 'Chorwacja',   homeGoals: 1, awayGoals: 5 },
    { home: 'Gibraltar',   away: 'Wyspy Owcze', homeGoals: 0, awayGoals: 1 },
    { home: 'Czarnogóra',  away: 'Chorwacja',   homeGoals: 2, awayGoals: 3 },
  ],
};
