...
export type LiveMatchUserPhysicalActionSuppression = {
  ...
  redZonePlayerCount: number;
  criticalExhaustionActionCap: number | null;
...
export const calculateLiveCriticalExhaustionActionCap = (redZonePlayerCount: number): number | null => {
 ...
 * It also exposes a hard action cap when many user players are in the red zone below 60 condition,
 * because a team full of players on the edge of collapse should not be able to exploit the normal
