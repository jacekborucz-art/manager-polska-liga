...
export const CONFR2QDrawView: React.FC = () => {
  const { activeCupDraw, confirmCONFR2QDraw, clubs, navigateTo } = useGame();
  ...
  const getCountry = (clubId: string): string => {
    if (clubId.startsWith('PL_')) return COUNTRY_NAMES['POL'];
