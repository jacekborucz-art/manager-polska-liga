...
export const PostMatchELStudioView: React.FC = () => {
  ...
  const isReturn = !!firstResult && (
    firstResult.leagueId === CompetitionType.EL_R1Q_RETURN ||
    firstResult.leagueId === CompetitionType.EL_R2Q_RETURN ||
    firstResult.leagueId === CompetitionType.EL_R16_RETURN ||
    firstResult.leagueId === CompetitionType.EL_QF_RETURN ||
    firstResult.leagueId === CompetitionType.EL_SF_RETURN
  );

  const getRoundLabel = (): string => {
    if (!firstResult) return 'Liga Europy · Wyniki';
    switch (firstResult.leagueId) {
      case CompetitionType.EL_R1Q:         return '1. Mecz — 1. Runda Kwalifikacyjna · Wyniki';
      case CompetitionType.EL_R1Q_RETURN:  return 'Rewanż — 1. Runda Kwalifikacyjna · Wyniki';
      case CompetitionType.EL_R2Q:         return '1. Mecz — 2. Runda Kwalifikacyjna · Wyniki';
      case CompetitionType.EL_R2Q_RETURN:  return 'Rewanż — 2. Runda Kwalifikacyjna · Wyniki';
      case CompetitionType.EL_GROUP_STAGE: return 'Faza Grupowa · Wyniki';
      case CompetitionType.EL_R16:         return '1/8 Finału — 1. Mecz · Wyniki';
      case CompetitionType.EL_R16_RETURN:  return '1/8 Finału — Rewanż · Wyniki';
      case CompetitionType.EL_QF:          return '1/4 Finału — 1. Mecz · Wyniki';
      case CompetitionType.EL_QF_RETURN:   return '1/4 Finału — Rewanż · Wyniki';
      case CompetitionType.EL_SF:          return '1/2 Finału — 1. Mecz · Wyniki';
      case CompetitionType.EL_SF_RETURN:   return '1/2 Finału — Rewanż · Wyniki';
      case CompetitionType.EL_FINAL:       return 'Finał Ligi Europy · Wynik';
      default:                             return 'Liga Europy · Wyniki';
    }
  };
      ...
      <div className="relative z-10 flex flex-col h-full p-6 gap-4">
        ...
        <div className={GLASS_CARD + " p-6 flex items-center justify-between shrink-0"}>
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              <p className="text-[9px] font-black uppercase tracking-[0.5em] text-orange-400">UEFA Europa League · Wyniki</p>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3 flex-1 justify-end">
                        {aggWinnerId === fixture.homeTeamId && (
                          <span className="text-orange-400 text-[9px] font-black uppercase tracking-[0.3em]">AWANS</span>
                        )}
