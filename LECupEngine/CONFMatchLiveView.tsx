 ...
 const hasScored = matchState.awayGoals.some(g => g.playerName === p.lastName && !g.isMiss && !g.varDisallowed);
  ...
  {matchState.isFinished ? (
    ...
    <>
      ...
      <div className={`group/tactics flex gap-3 justify-center py-2 px-6 bg-black/65 border border-white/15 rounded-[22px] shadow-[0_20px_70px_rgba(0,0,0,0.65)] relative overflow-hidden backdrop-blur-2xl transition-all duration-300 hover:border-white/25 hover:bg-black/70${showBriefing ? ' opacity-40 pointer-events-none' : ''}`}>
